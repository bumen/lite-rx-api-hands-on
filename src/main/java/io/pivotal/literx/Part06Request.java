...
//========================================================================================
	...
	Flux<User> fluxWithDoOnPrintln() {
		return repository.findAll().doOnSubscribe(u-> System.out.println("Starring")).doOnNext(u-> System.out
			.println(u.getFirstname() + "_" + u.getLastname())).doOnComplete(()-> System.out.println("The end!"));
	}
