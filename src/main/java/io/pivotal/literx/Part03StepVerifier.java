 ...
 * @see <a href="http://projectreactor.io/docs/test/release/api/reactor/test/StepVerifier.html">StepVerifier
 * Javadoc</a>
 */
...
//========================================================================================
    ...
    void expect3600Elements(Supplier<Flux<Long>> supplier) {
        ...
        StepVerifier.withVirtualTime(supplier).thenAwait(Duration.ofHours(1)).expectNextCount(3600)
            .verifyComplete();

        // 上面的withVirtualTime是等待虚拟时间，会使用虚拟的schedule执行器，其真实的wait时间比较小，如果不加
        // thenAwait则真的要执行一个小时
    }
